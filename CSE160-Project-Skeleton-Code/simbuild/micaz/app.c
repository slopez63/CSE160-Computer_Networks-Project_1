...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7c4d668, const void *arg_0xb7c4d7ec);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7c0493c) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb7ab9d88), 
int (*key_eq_fn)(void *arg_0xb7ab71cc, void *arg_0xb7ab7334));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb7991958, int arg_0xb7991aa4);
static double RandomUniform(void );
...
typedef uint8_t Node__neighborList__t;
typedef pack *Node__packList__t;
typedef TMilli Node__checkNeigh__precision_tag;
...
typedef pack */*NodeC.packListC*/ListC__0__t;
typedef /*NodeC.packListC*/ListC__0__t /*NodeC.packListC*/ListC__0__List__t;
typedef uint8_t /*NodeC.neighborListC*/ListC__1__t;
...
static void Node__checkNeigh__fired(void );
...
static uint16_t /*NodeC.packListC*/ListC__0__List__size(void );
static /*NodeC.packListC*/ListC__0__List__t /*NodeC.packListC*/ListC__0__List__get(uint16_t position);
#line 17
static void /*NodeC.packListC*/ListC__0__List__pushback(/*NodeC.packListC*/ListC__0__List__t input);
...
static /*NodeC.neighborListC*/ListC__1__List__t /*NodeC.neighborListC*/ListC__1__List__popback(void );
...
static Node__neighborList__t Node__neighborList__popback(void );




static uint16_t Node__packList__size(void );
static Node__packList__t Node__packList__get(uint16_t position);
#line 17
static void Node__packList__pushback(Node__packList__t input);
# 4 "lib/interfaces/SimpleSend.nc"
static error_t Node__Sender__send(pack msg, uint16_t dest);
# 64 "/home/sigi/CSE160/tiny/tinyos-main/tos/lib/timer/Timer.nc"
static void Node__checkNeigh__startPeriodic(uint32_t dt);
# 32 "Node.nc"
pack Node__sendPackage[1000];
pack *Node__loopPackage[1000];
...
static bool Node__hasbeenseen(pack *pkg);
static inline bool Node__hasbeenseen2(pack *pkg2);

static inline void Node__clearList2(void );
...
static inline void Node__checkNeigh__fired(void );
#line 240
static void Node__makePack(pack *Package, uint16_t src, uint16_t dest, uint16_t TTL, uint16_t protocol, uint16_t seq, uint8_t *payload, uint8_t length);
#line 264
static bool Node__hasbeenseen(pack *pkg);
...
uint16_t /*NodeC.packListC*/ListC__0__MAX_SIZE[1000];

/*NodeC.packListC*/ListC__0__t /*NodeC.packListC*/ListC__0__container[1000][64];
uint16_t /*NodeC.packListC*/ListC__0__size[1000];

static void /*NodeC.packListC*/ListC__0__List__pushback(/*NodeC.packListC*/ListC__0__t input);
#line 87
static inline uint16_t /*NodeC.packListC*/ListC__0__List__size(void );



static inline /*NodeC.packListC*/ListC__0__t /*NodeC.packListC*/ListC__0__List__get(uint16_t position);
#line 16
...
#line 44
static inline /*NodeC.neighborListC*/ListC__1__t /*NodeC.neighborListC*/ListC__1__List__popback(void );
#line 87
...
#line 296
  size = Node__neighborList__size();

  for (i = 0; i < size; i++) {
      tmp = Node__neighborList__get(i);
      if (tmp == __nesc_ntoh_uint16(pkg2->src.nxdata)) {
          return TRUE;
        }
    }
...
# 17 "dataStructures/interfaces/List.nc"
inline static void Node__packList__pushback(Node__packList__t input){
#line 17
  /*NodeC.packListC*/ListC__0__List__pushback(input);
#line 17
}
#line 17
# 73 "Node.nc"
...
#line 75
  ...
  if (len == sizeof(pack )) {
      ...
      if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PING) {
          ...
          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && Node__hasbeenseen(myMsg) == FALSE) {
              Node__packList__pushback(myMsg);

              sim_log_debug(111U, FLOODING_CHANNEL, "Package Delivered and Acknoleged\n");
              sim_log_debug(112U, FLOODING_CHANNEL, "Package Payload: %s\n", myMsg->payload);


              Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata), PROTOCOL_PINGREPLY, 0, "REPLY", PACKET_MAX_PAYLOAD_SIZE);
          ...
          if (Node__hasbeenseen(myMsg) == FALSE) {
              Node__packList__pushback(myMsg);

              sim_log_debug(113U, FLOODING_CHANNEL, "Packet Fowarded\n");
              Node__makePack(&Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, PROTOCOL_PING, __nesc_ntoh_uint16(myMsg->seq.nxdata) + 1, myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
              Node__Sender__send(Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->dest.nxdata));
          ...
          sim_log_debug(114U, FLOODING_CHANNEL, "Packet Ignored\n");
          return msg;
        }
      ...
      if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_PINGREPLY) {
          ...
          sim_log_debug(115U, FLOODING_CHANNEL, "Reply Recieved\n");

          if (__nesc_ntoh_uint16(myMsg->dest.nxdata) == TOS_NODE_ID && Node__hasbeenseen(myMsg) == FALSE) {
              Node__packList__pushback(myMsg);
              sim_log_debug(116U, FLOODING_CHANNEL, "Reply Recieved and Acknoleged\n");
              sim_log_debug(117U, FLOODING_CHANNEL, "SEQ %d\n", __nesc_ntoh_uint16(myMsg->seq.nxdata));
          ...
          if (Node__hasbeenseen(myMsg) == FALSE) {
              ...
              Node__packList__pushback(myMsg);
              sim_log_debug(118U, FLOODING_CHANNEL, "Reply Fowarded\n");

              Node__makePack(&Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint16(myMsg->dest.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, PROTOCOL_PINGREPLY, __nesc_ntoh_uint16(myMsg->seq.nxdata) + 1, myMsg->payload, PACKET_MAX_PAYLOAD_SIZE);
              Node__Sender__send(Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->dest.nxdata));
              return msg;
            }
          else 
#line 146
            {
              ...
              sim_log_debug(119U, FLOODING_CHANNEL, "Reply Ignored\n");
            }
      ...
      if (__nesc_ntoh_uint8(myMsg->protocol.nxdata) == PROTOCOL_NEIGHBOR) {
          ...
          if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) == 1 && Node__hasbeenseen2(myMsg) == FALSE) {
              Node__neighborList__pushback(__nesc_ntoh_uint16(myMsg->src.nxdata));
              return msg;
            }
          else {
#line 164
            if (__nesc_ntoh_uint8(myMsg->TTL.nxdata) == 2) {
                Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, __nesc_ntoh_uint16(myMsg->src.nxdata), __nesc_ntoh_uint8(myMsg->TTL.nxdata) - 1, PROTOCOL_NEIGHBOR, __nesc_ntoh_uint16(myMsg->seq.nxdata) + 1, "NEIGHBOR REPLY", PACKET_MAX_PAYLOAD_SIZE);
                Node__Sender__send(Node__sendPackage[sim_node()], __nesc_ntoh_uint16(myMsg->src.nxdata));
                return msg;
              }
            else {
...
# 78 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Receive__receive(am_id_t arg_0xb77ce984, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb77ce984) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC__Receive__default__receive(arg_0xb77ce984, msg, payload, len);
#line 78
      break;
#line 78
    }
...
#line 87
{
  return /*NodeC.packListC*/ListC__0__size[sim_node()];
}

# 24 "dataStructures/interfaces/List.nc"
inline static uint16_t Node__packList__size(void ){
#line 24
  unsigned short __nesc_result;
#line 24

#line 24
  __nesc_result = /*NodeC.packListC*/ListC__0__List__size();
#line 24
...
#line 91
{
  return /*NodeC.packListC*/ListC__0__container[sim_node()][position];
}

# 25 "dataStructures/interfaces/List.nc"
inline static Node__packList__t Node__packList__get(uint16_t position){
#line 25
  nx_struct pack *__nesc_result;
#line 25

#line 25
  __nesc_result = /*NodeC.packListC*/ListC__0__List__get(position);
#line 25
...
# 78 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC__Snoop__receive(am_id_t arg_0xb77cd010, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC__Snoop__default__receive(arg_0xb77cd010, msg, payload, len);
#line 78
...
# 64 "/home/sigi/CSE160/tiny/tinyos-main/tos/lib/timer/Timer.nc"
inline static void Node__checkNeigh__startPeriodic(uint32_t dt){
#line 64
...
#line 54
{
  if (err == SUCCESS) {
      ...
      Node__checkNeigh__startPeriodic(500);
    }
  else 
#line 58
    {
  ...
  sim_log_debug(110U, NEIGHBOR_CHANNEL, "Started Neighbor Timer\n");
}
...
# 110 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC__AMSend__sendDone(am_id_t arg_0xb77ce010, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__sendDone(arg_0xb77ce010, msg, error);
#line 110
}
#line 110
...
#line 88
# 80 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__AMSend__send(am_id_t arg_0xb743acac, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC__AMSend__send(arg_0xb743acac, addr, msg, len);
#line 80
...
#line 118
{
  if (!/*NodeC.SimpleSendC.SimpleSendP*/SimpleSendP__0__busy[sim_node()]) {
      ...
      *msg = *message;
      ...
      if (/*NodeC.SimpleSendC.SimpleSendP*/SimpleSendP__0__AMSend__send(AM_BROADCAST_ADDR, &/*NodeC.SimpleSendC.SimpleSendP*/SimpleSendP__0__pkt[sim_node()], sizeof(pack )) == SUCCESS) {
...
#line 133
        {
          ...
          sim_log_debug(126U, GENERAL_CHANNEL, "The radio is busy, or something\n");
          return FAIL;
        }
    }
  else 
#line 138
    {
      sim_log_debug(127U, GENERAL_CHANNEL, "The radio is busy");
      return EBUSY;
    }


  sim_log_debug(128U, GENERAL_CHANNEL, "FAILED!?");
  return FAIL;
}
...
# 100 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__sendDone(uint8_t arg_0xb743a310, message_t * msg, error_t error){
#line 100
  switch (arg_0xb743a310) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP__0__Send__default__sendDone(arg_0xb743a310, msg, error);
#line 100
      break;
#line 100
    }
...
#line 197
  ...
  if (size == 0) {
      sim_log_debug(122U, NEIGHBOR_CHANNEL, "list is empty\n");
    }

  for (i = 0; i < size; i++) {
      tmp = Node__neighborList__get(i);
      sim_log_debug(123U, NEIGHBOR_CHANNEL, "This node is my neighbor:             %d\n", tmp);
    }
}
...
#line 187
{
  sim_log_debug(121U, GENERAL_CHANNEL, "PING EVENT \n");
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, destination, MAX_TTL, PROTOCOL_PING, 0, payload, PACKET_MAX_PAYLOAD_SIZE);
...
#line 22
{
  if (!CommandHandlerP__Queue__empty()) {
      ...
      sim_log_debug(172U, COMMAND_CHANNEL, "A Command has been Issued.\n");
      ...
      switch (commandID) {
          ...
          case CMD_PING: 
            sim_log_debug(173U, COMMAND_CHANNEL, "Command Type: Ping\n");
          CommandHandlerP__CommandHandler__ping(buff[0], &buff[1]);
          break;

          case CMD_NEIGHBOR_DUMP: 
            sim_log_debug(174U, COMMAND_CHANNEL, "Command Type: Neighbor Dump\n");
          CommandHandlerP__CommandHandler__printNeighbors();
          break;

          case CMD_LINKSTATE_DUMP: 
            sim_log_debug(175U, COMMAND_CHANNEL, "Command Type: Link State Dump\n");
          CommandHandlerP__CommandHandler__printLinkState();
          break;

          case CMD_ROUTETABLE_DUMP: 
            sim_log_debug(176U, COMMAND_CHANNEL, "Command Type: Route Table Dump\n");
          ...
          default: 
            sim_log_debug(179U, COMMAND_CHANNEL, "CMD_ERROR: \"%d\" does not match any known commands.\n", __nesc_ntoh_uint8(msg->id.nxdata));
          break;
        }
      CommandHandlerP__Pool__put(raw_msg);
    }
...
# 75 "/home/sigi/CSE160/tiny/tinyos-main/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP__TaskBasic__runTask(uint8_t arg_0xb78e4478){
#line 75
  switch (arg_0xb78e4478) {
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP__TaskBasic__default__runTask(arg_0xb78e4478);
#line 75
      break;
#line 75
    }
...
#line 44
{
  /*NodeC.neighborListC*/ListC__1__t returnVal;

  returnVal = /*NodeC.neighborListC*/ListC__1__container[sim_node()][/*NodeC.neighborListC*/ListC__1__size[sim_node()]];


  if (/*NodeC.neighborListC*/ListC__1__size[sim_node()] > 0) {
#line 50
    /*NodeC.neighborListC*/ListC__1__size[sim_node()]--;
    }
#line 51
...
inline static Node__neighborList__t Node__neighborList__popback(void ){
#line 19
  unsigned char __nesc_result;
#line 19

#line 19
  __nesc_result = /*NodeC.neighborListC*/ListC__1__List__popback();
#line 19
...
#line 224
{
  ...
  Node__makePack(&Node__sendPackage[sim_node()], TOS_NODE_ID, 0, 2, PROTOCOL_NEIGHBOR, 0, "NEIGHBOR DISCOVERY", PACKET_MAX_PAYLOAD_SIZE);
  Node__Sender__send(Node__sendPackage[sim_node()], 0);
}
...
# 83 "/home/sigi/CSE160/tiny/tinyos-main/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__fired(uint8_t arg_0xb749cefc){
#line 83
  switch (arg_0xb749cefc) {
#line 83
    case 0U:
#line 83
...
#line 83
    case 1U:
#line 83
      Node__checkNeigh__fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC__0__Timer__default__fired(arg_0xb749cefc);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(155U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP__compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP__overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(154U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP__overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(151U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(152U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(144U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(134U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(139U, "HplAtm128Timer0AsyncP", "TIFR is %hhx\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x36]);
          sim_log_debug(140U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(141U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 364
{
  sim_log_debug(146U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 267
  size = Node__packList__size();

  for (i = 0; i < size; i++) {
      Node__loopPackage[sim_node()] = Node__packList__get(i);
      if ((__nesc_ntoh_uint16(Node__loopPackage[sim_node()]->src.nxdata) == __nesc_ntoh_uint16(pkg->src.nxdata) || __nesc_ntoh_uint16(Node__loopPackage[sim_node()]->seq.nxdata) < __nesc_ntoh_uint16(pkg->seq.nxdata)) && __nesc_ntoh_uint8(pkg->protocol.nxdata) == __nesc_ntoh_uint8(Node__loopPackage[sim_node()]->protocol.nxdata) && __nesc_ntoh_uint8(pkg->protocol.nxdata) == PROTOCOL_PING) {
          return TRUE;
        }
      if (Node__loopPackage[sim_node()]->payload == pkg->payload && __nesc_ntoh_uint8(pkg->protocol.nxdata) == __nesc_ntoh_uint8(Node__loopPackage[sim_node()]->protocol.nxdata) && __nesc_ntoh_uint8(pkg->protocol.nxdata) == PROTOCOL_PINGREPLY) {
          return TRUE;
        }
    }
#line 290
...
#line 21
{
  ...
  if (/*NodeC.packListC*/ListC__0__size[sim_node()] < /*NodeC.packListC*/ListC__0__MAX_SIZE[sim_node()]) {

      /*NodeC.packListC*/ListC__0__container[sim_node()][/*NodeC.packListC*/ListC__0__size[sim_node()]] = input;
      /*NodeC.packListC*/ListC__0__size[sim_node()]++;
    }
}
...
#line 285
  ...
  sim_log_debug(143U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(149U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 101
      sim_log_debug(129U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__MINDT) {
              sim_log_debug(130U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(131U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP__0__set[sim_node()]) {
          ...
          sim_log_debug(132U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(150U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(153U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(142U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "Node__loopPackage"))
  {
    *addr = (uintptr_t)&Node__loopPackage[__nesc_mote];
    *size = sizeof(Node__loopPackage[__nesc_mote]);
    return 0;
  }
  ...
  /* Module ListC__0 */
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__0__MAX_SIZE"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__0__MAX_SIZE[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__0__MAX_SIZE[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__0__container"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__0__container[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__0__container[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "/*NodeC.packListC*/ListC__0__size"))
  {
    *addr = (uintptr_t)&/*NodeC.packListC*/ListC__0__size[__nesc_mote];
    *size = sizeof(/*NodeC.packListC*/ListC__0__size[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  memset((void *)&Node__loopPackage[__nesc_mote], 0, sizeof Node__loopPackage[__nesc_mote]);
  ...
  /* Module ListC__0 */
  /*NodeC.packListC*/ListC__0__MAX_SIZE[__nesc_mote] = 64;
  memset((void *)&/*NodeC.packListC*/ListC__0__container[__nesc_mote], 0, sizeof /*NodeC.packListC*/ListC__0__container[__nesc_mote]);
  /*NodeC.packListC*/ListC__0__size[__nesc_mote] = 0;
